...
const OurProperties = () => {
  const properties = [
    ...
    },
    {
      id: 2,
      name: "Enliven Residency",
      address: "Niladri Vihar, Near Care Hospital (Backside of KV-4)  Bhubaneswar - 751021",
      type: "hotel",
      image: "/room2.jpg",
      description:
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 font-content max-w-2xl mx-auto">
            Discover our collection of luxury accommodations and fine dining experiences across Bhubaneswar
          </p>
        </div>
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="flex items-center text-gray-600 mb-4">
                  ...
                  <span className="font-content text-sm">{property.address}</span>
                </div>
                ...
                {/* Action Link Button - Fixed at bottom */}
                <Link
                  to={property.link}
